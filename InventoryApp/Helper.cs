...
namespace InventoryApp
{
    internal class Helper
    {
        public SqlConnection GetConnection()
        {
            ...
            connection.ConnectionString = "Data Source=LAPTOP-00DLQS6O;Initial Catalog=inventory-app;Integrated Security=True";
        ...
        public void LogActivity(String logAcivity)
        {
            SqlConnection connection = GetConnection();
            SqlCommand command = new SqlCommand();
            command.Connection = connection;
            connection.Open();
            command.CommandType = CommandType.Text;
            command.CommandText = "insert into log_activity (id_user, activity) values('"+Form1.id_user+"', '"+logAcivity + "')";
            command.ExecuteNonQuery();
            connection.Close();
        }
